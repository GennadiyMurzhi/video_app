...
mixin _$UserValueFailure<T> {
  FilePickerResult? get failedValue => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(FilePickerResult? failedValue)
        emptyFilePickerPhotoResult,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(FilePickerResult? failedValue)? emptyFilePickerPhotoResult,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>({
    required TResult Function(EmptyFilePickerPhotoResult<T> value)
        emptyFilePickerPhotoResult,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult Function(EmptyFilePickerPhotoResult<T> value)?
        emptyFilePickerPhotoResult,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
/// @nodoc
abstract class _$$EmptyFilePickerPhotoResultCopyWith<T, $Res>
    implements $UserValueFailureCopyWith<T, $Res> {
  factory _$$EmptyFilePickerPhotoResultCopyWith(
          _$EmptyFilePickerPhotoResult<T> value,
          $Res Function(_$EmptyFilePickerPhotoResult<T>) then) =
      __$$EmptyFilePickerPhotoResultCopyWithImpl<T, $Res>;
  @override
  $Res call({FilePickerResult? failedValue});
}

/// @nodoc
class __$$EmptyFilePickerPhotoResultCopyWithImpl<T, $Res>
    extends _$UserValueFailureCopyWithImpl<T, $Res>
    implements _$$EmptyFilePickerPhotoResultCopyWith<T, $Res> {
  __$$EmptyFilePickerPhotoResultCopyWithImpl(
      _$EmptyFilePickerPhotoResult<T> _value,
      $Res Function(_$EmptyFilePickerPhotoResult<T>) _then)
      : super(_value, (v) => _then(v as _$EmptyFilePickerPhotoResult<T>));

  @override
  _$EmptyFilePickerPhotoResult<T> get _value =>
      super._value as _$EmptyFilePickerPhotoResult<T>;

  @override
  $Res call({
    Object? failedValue = freezed,
  }) {
    return _then(_$EmptyFilePickerPhotoResult<T>(
      failedValue: failedValue == freezed
          ? _value.failedValue
          : failedValue // ignore: cast_nullable_to_non_nullable
              as FilePickerResult?,
...
class _$EmptyFilePickerPhotoResult<T> implements EmptyFilePickerPhotoResult<T> {
  const _$EmptyFilePickerPhotoResult({required this.failedValue});
  ...
  @override
  String toString() {
    return 'UserValueFailure<$T>.emptyFilePickerPhotoResult(failedValue: $failedValue)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$EmptyFilePickerPhotoResult<T> &&
            const DeepCollectionEquality()
                .equals(other.failedValue, failedValue));
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$EmptyFilePickerPhotoResultCopyWith<T, _$EmptyFilePickerPhotoResult<T>>
      get copyWith => __$$EmptyFilePickerPhotoResultCopyWithImpl<T,
          _$EmptyFilePickerPhotoResult<T>>(this, _$identity);
  ...
  TResult when<TResult extends Object?>({
    ...
    return emptyFilePickerPhotoResult(failedValue);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return emptyFilePickerPhotoResult?.call(failedValue);
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    if (emptyFilePickerPhotoResult != null) {
      return emptyFilePickerPhotoResult(failedValue);
    }
    return orElse();
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return emptyFilePickerPhotoResult(this);
  }
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    return emptyFilePickerPhotoResult?.call(this);
  }
...
abstract class EmptyFilePickerPhotoResult<T> implements UserValueFailure<T> {
  const factory EmptyFilePickerPhotoResult(
          {required final FilePickerResult? failedValue}) =
      _$EmptyFilePickerPhotoResult<T>;
